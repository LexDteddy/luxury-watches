...
;( function() {
    ...
    function factory(classie) {
        ...
        SelectFx.prototype._createSelectEl = function() {
            ...
            this.el.parentNode.insertBefore(this.selEl, this.el); // Insert before the original select element
            this.selEl.appendChild(this.el); // Append the original select element inside the custom select element
